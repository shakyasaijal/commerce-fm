...
if settings.HAS_REFERRAL_APP:
    ...
    class Block(user_models.AbstractTimeStamp):
        ...
        data_hash = models.CharField(max_length=255, null=False, blank=False, unique=True)
        previous_has = models.TextField(null=False, blank=False, default="00xx00")
        genesis_block = models.BooleanField(null=False, blank=False, choices=modelHelper.genesis_block, default=False)
